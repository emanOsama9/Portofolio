...
<h3>TodoList</h3>
        <p>An interactive task management app where can add, delete, and update tasks. users  </p>
           <br/>
         <br/>
         <a href="https://emanosama9.github.io/todolist/" className='text-white ' target="_blank" ><h3 className='border border-purple-600  px-2 py-2'>GitHub: https://emanosama9.github.io/todolist/</h3> </a>
